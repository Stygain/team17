...
public class Routes implements ApplicationRoutes {
    ...
    public void init(Router router) {  
        ...
        router.POST().route("/newStandardGame").with(ApplicationController.class, "standardPost");
        router.POST().route("/newSpanishGame").with(ApplicationController.class, "spanishPost");
